$(document).ready(function(){
	...
	$('body').on('click', '.active-property', function() {
        ...
        var ID = $(this).attr('rel');
        swal({
            title: "Are you sure you this property are not available?",
            text: "",
            icon: "warning",
            buttons: ['No, cancel it!', 'Yes, I am sure!'],
            dangerMode: !0,
            ...
            if (isConfirm) {
                swal({
                    title: 'Not Available!',
                    text: 'Property has been  successfully not available!',
                    icon: 'success'
                }).then(function() {
                    H5_loading.show();
                    $.ajax({
	...
	$('body').on('click', '.deactive-property', function() {
        ...
        var ID = $(this).attr('rel');
        swal({
            title: "Are you sure you this property are available?",
            text: "",
            icon: "warning",
            buttons: ['No, cancel it!', 'Yes, I am sure!'],
            dangerMode: !0,
            ...
            if (isConfirm) {
                swal({
                    title: 'Available!',
                    text: 'Property has been  successfully available!',
                    icon: 'success'
                }).then(function() {
                    H5_loading.show();
                    $.ajax({
