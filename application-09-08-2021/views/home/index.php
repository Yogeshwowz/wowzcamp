...
<section class="h-banner">
        ...
        <h1 class="h-banner-head main-color">Find and book best Stayz in Kasauli</h1>
        ...
        <div class="row">
            ...
            <input class="btn main-btn my-2 my-sm-0 " type="submit" value="Search" name="homesearch" id="homesearch">
        </div>
    </div>
