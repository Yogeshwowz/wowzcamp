          ...
          <div class="row align-items-center py-4">
            ...
            <div class="col-lg-3 col-7">
              ...
              <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                  <li class="breadcrumb-item"><a href="<?php echo base_url();?>administrator/dashboard"><i class="fas fa-home"></i></a></li>
                  <li class="breadcrumb-item"><a href="<?php echo base_url();?>administrator/create-tent">Add New Tent</a></li>
              ...
              <table class="table table-flush" id="datatable-basic">
				...
				<?php foreach($properties as $properties) { ?>
                  <tr>
                    ...
                    <td><a target="_blank" class="aeditclass" href="<?php echo base_url();?>administrator/edit-tent/tent/<?php echo base64_encode($properties->id)?>">Edit</a>
					|<span rel="<?php echo $properties->id;?>"  data-type="tent" class="delete-property">Delete</span>| <a target="_blank" class="agalleryclass" href="<?php echo base_url();?>administrator/tent-gallery/tent/<?php echo base64_encode($properties->id)?>">Gallery</a>| <a target="_blank" class="aamenityclass" href="<?php echo base_url();?>administrator/tent-amenity/tent/<?php echo base64_encode($properties->id)?>">Amenity</a> 
					</td>
				</tr><?php  }  ?>
