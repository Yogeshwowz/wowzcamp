        ...
        <div class="col">
		 <div class="card">
          <div class="card-body">
            <!-- Card header -->
             <div class="row">
			  <form class="formcls" action="<?php echo base_url();?>administrator/edit-service/<?php echo $this->uri->segment(3);?>" method="post" role="form" novalidate=""   id="my_service" enctype="multipart/form-data">
					...
					<div class="form-row">
                      ...
                      <textarea class="form-control" name="description" id="description"  required="true"><?php if(!empty($result['description'])) { echo $result['description']; } ?></textarea>
                      </div>
					</div>
					<div class="form-row">
                       <div class="col-md-12">
