            ...
            <!-- Card header -->
             <div class="row">
			  <form class="formcls" action="<?php echo base_url();?>administrator/create-property" method="post" role="form" novalidate=""   id="my_property" enctype="multipart/form-data">
					...
					<span class="alert-text">Cottage property has been updated successfully</span>
					...
					<div class="form-row">
                       <div class="col-md-12">
                      <label class="form-control-label" for="editor1">Cottage Name</label>
						 <input  type="text" class="form-control" name="propertyname" id="propertyname" placeholder="Enter Cottage name"  value="<?php if(!empty($properties['propertyname'])) { echo $properties['propertyname']; }?>" required="true">
                      </div>
					</div>
					
					<div class="form-row">
                       <div class="col-md-12">
                       <label class="form-control-label" for="edito">Cottage Capacity</label>
					  <div class="field_wrapper row">
					  <div class="col-md-12 main-div">
					  <div class="col-md-6" style="float:left;">
						<select class="form-control js-example-basic-single1" name="room_type[]"  placeholder="Enter Cottage Name" required="true">
					...
					<div class="form-row">
                       <div class="col-md-12">
                      <label class="form-control-label" >Cottage Regular Price</label>
                      <input type="text" class="form-control amount" name="price" id="price" placeholder="Enter Cottage Price" required="true" value="<?php if(!empty($properties['price'])) { echo $properties['price']; }?>">
					   </div>
					</div>
					<div class="form-row">
                       <div class="col-md-12">
                      <label class="form-control-label" >Discount</label>
                     <input type="text" class="form-control amount" name="discount" id="discount" placeholder="Enter Cottage Discount" value="<?php if(!empty($properties['discount'])) { echo $properties['discount']; }?>">
					...
					<input type="hidden" class="form-control" name="property_type" id="property_type" placeholder="Enter location" value="cottage">
