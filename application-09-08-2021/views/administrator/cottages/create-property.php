            ...
            <!-- Card header -->
             <div class="row">
			  <form class="formcls" action="<?php echo base_url();?>administrator/create-property" method="post" role="form" novalidate=""   id="my_property" enctype="multipart/form-data">
					...
					<span class="alert-text">Cottage property has been created successfully</span>
					...
					<div class="form-row">
                      ...
                      <label class="form-control-label" for="editor1">Cottage Name</label>
						 <input  type="text" class="form-control" name="propertyname" id="propertyname" placeholder="Enter Cottage name" required="true">
                      </div>
					</div>
					<div class="form-row">
                       <div class="col-md-12">
					...
					<div class="form-row">
                      ...
                      <input type="text" class="form-control amount" name="price" id="price" placeholder="Enter Cottage Price" required="true">
					   </div>
					</div>
					<div class="form-row">
                       <div class="col-md-12">
                      <label class="form-control-label" >Discount</label>
                     <input type="text" class="form-control amount" name="discount" id="discount" placeholder="Enter Cottage Discount">
