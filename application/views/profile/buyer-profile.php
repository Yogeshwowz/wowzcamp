<style>.thumbnail-img{width:50px;height:50px;} .error-select { border: 1px solid #f00!important;}</style>
<section class="Investor_form">
   <div class="container">
      <h2 class="main_h2">Register Buyer Profile</h2>
      <div class="row">
         <div class="col-md-8 pr-5">
            <div  id="profile-form-success" class="alert alert-success alert-dismissible fade show hidecls" role="alert">               <span class="alert-icon"><i class="ni ni-like-2"></i></span>               <span class="alert-text">Thank you for providing the basic details of your profile. To publish your profile publicly please select the plans below.</span>               <button type="button" class="close" data-dismiss="alert" aria-label="Close">               <span aria-hidden="true">&times;</span>               </button>            </div>
            <form  id="buyer-profile-frm" method="POST" action="" role="form" novalidate=""enctype="multipart/form-data" >
               ...
               <div class="pro_box requirement_box bg_white">
                  ...
                  <div class="row">
                     ...
                     <div class="col-md-6 mb-2">                        
					 <input   rel="proof" style="display:none;" type="file" name="attach_proof" id="attach_proof">                        <label for="attach_proof" class="add_file_btn">Attach Proof</label>                        
