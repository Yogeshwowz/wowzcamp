        ...
        <div class="col">
		 <div class="card">
          <div class="card-body">
            <!-- Card header -->
             <div class="row">
			  <form class="formcls" action="<?php echo base_url();?>administrator/create-category" method="post" role="form" novalidate=""   id="my_category" enctype="multipart/form-data">
					 ...
					 <div class="form-row">
                      ...
                      <label class="form-control-label" for="editor1">Name</label>
					   ...
					   <input type="text" class="form-control" name="title" id="title" placeholder="Enter Name" required="true">
                      </div>
					</div>
					<div class="form-row">
                       <div class="col-md-12">
                      <label class="form-control-label" for="editor1">Description</label>
                      <textarea class="form-control" name="description" id="description_1"  required="true"></textarea>
                      </div>
					</div>
					<div class="form-row">
                       <div class="col-md-12">
