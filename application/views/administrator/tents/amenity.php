...
<div class="header bg-primary">
    ...
    <div class="container-fluid">
      <!-- Table -->
	   <form class="formcls" action="<?php echo base_url();?>administrator/tent-amenity/tent/<?php echo $this->uri->segment(4);?>" method="post" role="form" novalidate=""   >
      <div class="row">
        <div class="col">
		 ...
		 <div class="card">
          <div class="card-body">
		   <?php $success = $this->session->flashdata('success');
			...
			<h5 class="h3 mb-1">Tent Amenity</h5>
			</div>
		  <!-- Card header -->
