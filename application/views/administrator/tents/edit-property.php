                ...
                <div class="col-lg-6 col-7">
                    ...
                    <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                        <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                          ...
                          <li class="breadcrumb-item"><a href="<?php echo base_url();?>administrator/tents">Manage Tent</a></li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <!-- Card header -->
             <div class="row">
			  <form class="formcls" action="<?php echo base_url();?>administrator/create-property" method="post" role="form" novalidate=""   id="my_property" enctype="multipart/form-data">
					...
					<span class="alert-text">Tent property has been updated successfully</span>
					...
					<div class="form-row">
                       <div class="col-md-12">
                      <label class="form-control-label" for="editor1">Tent Name</label>
						 <input  type="text" class="form-control" name="propertyname" id="propertyname" placeholder="Enter Tent name"  value="<?php if(!empty($properties['propertyname'])) { echo $properties['propertyname']; }?>" required="true">
                      </div>
					</div>
					<div class="form-row">
                       <div class="col-md-12">
                       <label class="form-control-label" for="edito">Tent Capacity</label>
					...
					<div class="form-row">
                       <div class="col-md-12">
                      <label class="form-control-label" >Tent Regular Price</label>
                      <input type="text" class="form-control amount" name="price" id="price" placeholder="Enter Tent Price" required="true" value="<?php if(!empty($properties['price'])) { echo $properties['price']; }?>">
					   </div>
					</div>
					<div class="form-row">
                       <div class="col-md-12">
                      <label class="form-control-label" >Discount</label>
                     <input type="text" class="form-control amount" name="discount" id="discount" placeholder="Enter Tent Discount" value="<?php if(!empty($properties['discount'])) { echo $properties['discount']; }?>">
