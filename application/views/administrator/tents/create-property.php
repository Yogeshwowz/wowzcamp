			  ...
			  <form class="formcls" action="<?php echo base_url();?>administrator/create-property" method="post" role="form" novalidate=""   id="my_property" enctype="multipart/form-data">
					...
					<div class="form-row">
                      ...
                      <label class="form-control-label" for="editor1">Tent Name</label>
						 <input  type="text" class="form-control" name="propertyname" id="propertyname" placeholder="Enter Tent name" required="true">
                      </div>
					</div>
					<div class="form-row">
                       <div class="col-md-12">
					  ...
					  <div class="col-md-6" style="float:left;">
						...
						<select class="form-control js-example-basic-single1" name="room_type[]"  placeholder="Enter Tent Name" required="true">
					...
					<div class="form-row">
                      ...
                      <input type="text" class="form-control amount" name="price" id="price" placeholder="Enter Tent Price" required="true">
					   </div>
					</div>
					<div class="form-row">
                       <div class="col-md-12">
                      <label class="form-control-label" >Discount</label>
                     <input type="text" class="form-control amount" name="discount" id="discount" placeholder="Enter Tent Discount">
