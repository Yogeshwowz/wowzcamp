					...
					<div class="card-body">
						...
						<div class="row">
							<form class="formcls" action="<?php echo base_url();?>administrator/create-property" method="post" role="form" novalidate=""   id="my_property" enctype="multipart/form-data">
								...
								<div class="form-row">
									<div class="col-md-12">
										<label class="form-control-label" for="edi">Select Hotel Name</label>
								...
								<div class="form-row" style="display:none;">
									<div class="col-md-12">
										...
										<input  type="text" class="form-control" name="propertyname" id="propertyname" placeholder="Enter Room name" >
									</div>
								</div>
								<div class="form-row">
									<div class="col-md-4">
									...
									<div class="col-md-4">
										<label class="form-control-label" for="edi">Available Rooms in Room Category</label>
									...
									<div class="col-md-4">
										...
										<select class="form-control js-example-basic-single" name="number_of_guest_select" id="number_of_guest_select" placeholder="Enter Category Name"
										...
										<div class="field_wrapper row">
											<div class="col-md-12 main-div">
												<div class="col-md-6" style="float:left;">
														...
														<option value="<?php echo $properties_type->id;?>" <?php if($properties_type->id==2){ echo"selected"; }?>><?php echo $properties_type->properties_type_size;?></option>
														<?php } ?>
													</select>
												</div>
												<div class="col-md-6" style="float:left;">
								...
								<div class="form-row">
									...
									<div class="col-md-4">
										...
										<input type="text" class="form-control" name="after_discount_price" id="after_discount_price" placeholder="Enter After Discount Price" readonly>
									</div>
								</div>
								...
								<div class="form-row">
									<div class="col-md-3" style="display:none;">
										...
										<select class="form-control" name="rating" id="rating" placeholder="Enter Location" >
									...
									<div class="col-md-9">
										...
										<input type="text" class="form-control amount" name="rating_status" id="rating_status" placeholder="Price Tag line" required="true" >
									</div>
								</div>
								<div class="form-row">
									<div class="col-md-2">
