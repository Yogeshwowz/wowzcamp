            ...
            <!-- Card header -->
             <div class="row">
			  <form class="formcls" action="<?php echo base_url();?>administrator/create-hotel" method="post" role="form" novalidate=""   id="my_hotel" enctype="multipart/form-data">
					...
					<span class="alert-text">Hotel has been updated successfully</span>
					...
					<span aria-hidden="true">&times;</span>
					 ...
					 <div class="form-row">
                      ...
                      <label class="form-control-label" for="editor1">User Name</label>
					   ...
					   <input type="text" class="form-control" name="username" id="username" placeholder="Enter User Name" required="true" value="<?php if(!empty($users['username'])) { echo $users['username'];}?>">
                      </div>
					</div>
					<div class="form-row">
                       <div class="col-md-12">
                      <label class="form-control-label" for="editor1">Email</label>
                      <input type="email" class="form-control" name="email" id="email" placeholder="Enter User Email" required="true" value="<?php if(!empty($users['email'])) { echo $users['email'];}?>">
                      </div>
					</div>
					<div class="form-row">
                       <div class="col-md-12">
                      <label class="form-control-label" for="editor1">Hotel Name</label>
                      <input type="text" class="form-control" name="hotel_name" id="hotel_name" placeholder="Enter User Hotel Name" required="true" value="<?php if(!empty($users['hotel_name'])) { echo $users['hotel_name'];}?>">
					    <input type="hidden" class="form-control" name="hotel_id" id="hotel_id" placeholder="Enter User Hotel Name"  value="<?php if(!empty($users['id'])) { echo $users['id'];}?>">
