<div class="header bg-primary">
		  ...
		  <?php } ?>
            <!-- Card header -->
             <div class="row">
			  ...
			  <form class="formcls" action="<?php echo base_url();?>administrator/camping-gallery/camping/<?php echo $this->uri->segment(4);?>" method="post" role="form" novalidate=""   id="my_property_gallery" enctype="multipart/form-data">
	...
	<div class="card-header">
       <h5 class="h3 mb-1">Camping Gallery Images</h5>
     </div>
	 ...
	 foreach($propertyImages as $propertyImages) { ?>
      <div class="card">
        ...
        <div class="card-body">
          <span class="btn btn-primary delete-property-image" data-type="camping"  rel="<?php echo $propertyImages->id;?>">Delete</span>
        </div>
      </div>
	  <?php } ?>
	</div><?php } else{ ?>
