   ...
   ?>
   <div class="container">
       <h1 class="h-banner-head main-color text-center">Find and book best STAYS in Kasauli</h1>
        <div class="row">
            <div class="i-group">
				...
				<select id="locationid" class="form-control main-select search-filter1 " name="location">
                    <option value="">Search</option>
						...
						<option value="<?php echo $city->id;?>" <?php  if(!empty($postdata['location'])){ if($postdata['location']==$city->id) { echo"selected";} } else{  if($city->id=='1233') { echo "selected";}} ?>><?php echo $city->name;?></option>
						<?php } ?>
                </select>
            </div>
            <div class="i-group">
            ...
            <button class="btn main-btn search-by-filter" type="button" >Search</button>
        </div>
    </div>
