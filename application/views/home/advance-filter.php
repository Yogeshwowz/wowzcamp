                            ...
                            <div class="side-filters d-block d-md-none">
                                ...
                                <div class="collapse" id="sfilter-6" data-parent="#sidebar_fbox">
                                    <div class="card card-body">
                                        <div class="form-group">
                                            <div class="form-check">
												<input class="form-check-input search-filter" type="radio"  name="sortproperties" id="sortby-type1" value="default">
                                                <label class="form-check-label" for="sortby-type1">Default Order</label>
                                            </div>
                                            <div class="form-check">
												<input  class="form-check-input search-filter" type="radio" name="sortproperties" id="sortby-type2" value="price-asc">
                                               <label class="form-check-label" for="sortby-type2">Price Low to High</label>
                                            </div>
                                            <div class="form-check">
												<input  class="form-check-input search-filter" type="radio"  name="sortproperties" id="sortby-type3" value="price-desc">
