			...
			function createTable(result,sno){
               ...
               tr += '</div>\
                <div class="col-lg-5 pt-4 d-flex flex-column">\
                    ...
                    <p class="pb-3 ">Location: <span class="text-limit">'+address+'</span></p>\
                    <div class="rating">'
					tr += '<h5>Rating</h5>';
                        tr += '<span class="main-btn py-1 px-2">'+rating+'<i class="fas fa-star pl-2"></i></span>\
                     </div>';
					 tr += '<div class="features py-3">';
