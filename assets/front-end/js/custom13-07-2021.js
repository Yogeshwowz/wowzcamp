			...
			function createTable(result,sno){
               ...
               tr += '</div>\
                <div class="col-lg-5 pt-4 d-flex flex-column">\
                    <h5 class="main-color mb-0">'+hotel_name+'</h5>\
					<p class="propertynamecls my-1">'+propertyname+'</p>\
                    <p class="pb-2 text-r1">Location: '+address+'</p>\
                    <div class="rating">\
                        Rating<span class="main-btn py-1 px-1 ml-2">'+rating+'<i class="fas fa-star pl-2"></i></span>\
                     </div>';
					 tr += '<div class="features py-2">';
					 if(amenities.length >0){
                    tr += '<h5 class="mb-0">Amenities</h5>';
					for(indx in amenities){
						var amenity_name = amenities[indx].amenity_name;
                       tr += ' <span class="main-color2 mr-2"><img src="'+baseUrl+'/assets/img/check-icon.png" alt=""> '+amenity_name+'</span>';
					}
						
					 }
					 tr += ' </div>';
					 if(description!=''){
                    tr += '<div class="list-des"><h5 class="mb-0">Description</h5>\
                        <p>'+description+'</p>\
                    </div>';
					 }
                     tr += '<div class="listing-footer mt-auto">\
                        <span class="listing-price">\
                            ...
                            <span class="main-price px-2"><i class="fas fa-rupee-sign"></i> '+price+'</span>\
